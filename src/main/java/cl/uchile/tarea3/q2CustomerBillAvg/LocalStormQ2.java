...
public class LocalStormQ2 {

    /**
     * @param args the command line arguments
     */
    private static final Logger LOG = LoggerFactory.getLogger(LocalStormQ2.class);
    ...
    public static void main(String[] args) {
        ...
        builder.setBolt("ClientFilter", new FilterBoltQ2(), 1)
                .shuffleGrouping("KafkaSpout");

        builder.setBolt("spentPerClient", new DataQ2ToCassandra(), 1)
                .shuffleGrouping("ClientFilter");
