...
public class LocalStormQ4 {

    /**
     * @param args the command line arguments
     */
    private static final Logger LOG = LoggerFactory.getLogger(LocalStormQ4.class);
    ...
    public static void main(String[] args) {
        ...
        builder.setBolt("SubsidiaryFilter", new FilterBoltQ4(), 1)
                .shuffleGrouping("KafkaSpout");

        builder.setBolt("subsidiarySales", new DataQ4ToCassandra(), 1)
                .shuffleGrouping("SubsidiaryFilter");
